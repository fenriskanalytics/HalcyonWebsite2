...
export type PinterestSvgrepoComSvg2IconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function PinterestSvgrepoComSvg2Icon(
  props: PinterestSvgrepoComSvg2IconProps
) {
