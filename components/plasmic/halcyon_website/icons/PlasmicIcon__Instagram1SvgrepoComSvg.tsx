...
export type Instagram1SvgrepoComSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function Instagram1SvgrepoComSvgIcon(
  props: Instagram1SvgrepoComSvgIconProps
) {
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <stop offset={".793"} stopColor={"#C62F94"}></stop>
        ...
        >
          ...
          <stop offset={".445"} stopColor={"#FB8A2E"}></stop>

          <stop offset={".715"} stopColor={"#E2425C"}></stop>
        ...
        >
          <stop offset={".157"} stopColor={"#406ADC"}></stop>

          <stop offset={".468"} stopColor={"#6A45BE"}></stop>
...
export default Instagram1SvgrepoComSvgIcon;
/* prettier-ignore-end */
